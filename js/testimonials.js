(() => {
  ...
  const DATA = [
    ...
    { asset: 1, quote: 'Their approach to product design is unlike anything we have experienced before.', body: 'Every decision was backed by research and deep understanding of our users. The result was a product that not only looks stunning but performs exceptionally well across all metrics we track.', name: 'Marko Petrovic' },
    { asset: 2, quote: 'A truly collaborative experience from start to finish.', body: 'The team took the time to understand our vision and translated it into a digital experience that exceeded our expectations. We have seen a significant increase in user engagement since launching.', name: 'Ana Jovanovic' },
  ];
